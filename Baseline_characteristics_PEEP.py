...
HighPEEP_ID = pickle.load(open('HighPEEP_ID.pkl','rb'))
LowPEEP_ID = pickle.load(open('LowPEEP_ID.pkl','rb'))

mask_HighPEEP = df['SUBJECT_ID'].isin(HighPEEP_ID)
mask_LowPEEP = df['SUBJECT_ID'].isin(LowPEEP_ID)

df_high = df.loc[mask_LowPEEP]
df_low = df.loc[mask_HighPEEP]
